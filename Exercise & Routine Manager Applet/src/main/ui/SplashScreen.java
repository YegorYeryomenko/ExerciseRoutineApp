...
public class SplashScreen extends JFrame {
    ...
    ImageIcon imageIconDumbbells = new ImageIcon("src/main/images/dumbbells.jpg");
    ImageIcon imageIconMetallica = new ImageIcon("src/main/images/metallica.jpg");
    ImageIcon imageIconNoHands = new ImageIcon("src/main/images/noHands.jpg");
